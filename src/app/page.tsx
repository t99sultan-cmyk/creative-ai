...
const faqs = [
  ...
  { q: "Это видеосъёмка или сток-видео? Я получу ролик с актёром?", a: "Нет. AICreative делает рекламные креативы двумя способами: 1) статичный PNG-постер (1080×1080 или 1080×1920) — собирается за 60 секунд; 2) полноценный видеоролик 5/10/15 секунд — после генерации статики одной кнопкой превращаем её в анимированное MP4 (живёт сцена, текст, эффекты вокруг твоего фото товара). Никаких актёров, никакой реальной съёмки, никакого сток-видео. Готово к запуску в Meta Ads, TikTok, Kaspi, Reels." },
    ...
    <main className="min-h-screen bg-neutral-50 text-neutral-900 font-sans overflow-x-hidden selection:bg-hermes-500/30 pb-20 md:pb-0">
          ...
          <div className="hidden md:flex items-center gap-4">
            {isSignedIn ? (
               ...
               <>
                 ...
                 <Link href="/register" className="text-sm font-bold text-white bg-hermes-500 hover:bg-hermes-600 px-5 py-2 rounded-full shadow-[0_0_20px_rgba(243,112,33,0.35)] transition-all">
                   Начать бесплатно
                 </Link>
               </>
            ) : (
      ...
      <section className="pt-32 pb-20 px-4 max-w-7xl mx-auto relative">
         <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-6 z-10">
               ...
               >
                 Перестаньте сливать бюджет на тесты. ИИ создаёт <strong>статичный креатив</strong>, а одной кнопкой превращает его в <strong>полноценный видеоролик 5–15 сек</strong> для Reels, Stories, TikTok и Kaspi — с <strong className="text-green-700 bg-green-100 px-2 py-0.5 rounded border border-green-200 ml-1 inline-block">CTR до 47%</strong>. Уже 2400+ маркетологов и селлеров используют AICreative.
               </motion.p>
      ...
      <section className="py-24 relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
               {[
                  { icon: Target, title: "Таргетологи и Медиабайеры", text: "Генерируйте десятки креатив-связок (постеры + motion-анимации) для тестов за 5 минут. Пробивайте баннерную слепоту и снижайте CPA.", stat: "Цена заявки -60%" },
         ...
         <div className="max-w-7xl mx-auto px-4 relative">
            ...
            <div className="relative grid md:grid-cols-4 gap-y-12 md:gap-x-6">
               ...
               {[
                  ...
                  { step: "04", icon: RefreshCw, title: "Скачай креатив", text: "Забирай готовый MP4-анимацию или PNG-постер в 4K за 60 секунд. Это не съёмка и не stock — это рекламный креатив, готовый к таргету.", accent: "from-green-500 to-emerald-500" },
               ].map((item, i) => (
            ...
            <div className="grid lg:grid-cols-2 gap-8">
               ...
               <Reveal delay={0.1}>
                  <div className="bg-white shadow-xl border border-neutral-200 rounded-3xl p-8 flex flex-col h-full hover:border-amber-500/30 transition-colors">
                     ...
                     <p className="text-neutral-600 text-lg italic mb-8 grow">
                        «Раньше платил дизайнеру по 3000 тенге за ОДИН статичный баннер. Сейчас мы выгружаем десятками motion-креативов для тестов гипотез. Стоимость лида упала в 2.5 раза за счёт крутого визуала.»
                     </p>
               ...
               <Reveal delay={0.2}>
                  <div className="bg-white shadow-xl border border-neutral-200 rounded-3xl p-8 flex flex-col h-full hover:border-hermes-500/30 transition-colors">
                     ...
                     <p className="text-neutral-600 text-lg italic mb-8 grow">
                        «Анимации — это разрыв! Закинула обычное фото крема клиента, через минуту ИИ отдал готовый 3D motion-креатив с каплями воды. Запустила в таргет Reels — клик упал с 18 центов до 4!»
                     </p>
                     <div className="grid grid-cols-2 gap-4">
                        <div className="bg-neutral-50 rounded-xl p-4 border border-neutral-100">
            ...
            <Reveal>
               <div className="text-center mb-16">
                  ...
                  <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
                     ...
                     <span className="font-semibold text-neutral-800">1 креатив = 4 ⚡</span>
                     ...
                     <div className={clsx(
                        ...
                        {(() => {
                          ...
                          return isSignedIn ? (
                            ...
                            // Anonymous user → /register with the checkout URL
                            // as the sanitized redirect param. After signup
                            // they go through /onboarding (welcome screen sets
                            // welcomeShown=true) and then bounce to checkout.
                            <Link
         ...
         <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            <Reveal>
               ...
               <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  {/* Signed-in → straight to editor. Signed-out → Clerk sign-in
                      which then lands them in the editor. Without the isSignedIn
                      gate, Clerk fires `cannot_render_single_session_enabled`
                      for already-logged-in visitors. */}
                  {isSignedIn ? (
                     <Link
                        href="/editor"
      ...
      {!isSignedIn && registrationOpen && (
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-t border-neutral-200 px-4 py-3 shadow-[0_-10px_30px_rgba(0,0,0,0.08)]">
          <Link href="/register" className="w-full flex items-center gap-3 active:scale-[0.98] transition-transform">
