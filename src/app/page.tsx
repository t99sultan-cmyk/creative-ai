...
const faqs = [
  ...
  { q: "Это видеосъёмка или сток-видео? Я получу ролик с актёром?", a: "Нет. AICreative делает рекламные креативы — это либо PNG-постер (статика, 1080×1080 или 1080×1920), либо MP4 с анимацией текста, типографики и эффектов вокруг твоего фото товара (motion-анимация, 10-15 секунд). Никаких актёров, никакой реальной съёмки, никакого сток-видео. Это умный рекламный пост, готовый к запуску в Meta Ads, TikTok, Kaspi, Reels." },
